...
public class DynamicSchedulingHandler {
     ...
     * @param triggerTask
     */
    public void addTriggerTask(String taskId, TriggerTask triggerTask) throws Exception {
        if (taskMap.containsKey(taskId)) {
            String message = "the taskId[{}] was added.";
            LOGGER.error(message, taskId);
     ...
     * @param cron
     */
    public void resetTriggerTask(String taskId, String cron) throws Exception {
